...
public class SubCategoryService {
    ...
    /**
     * Activate a sub category by its ID
     * Does NOT reactivate books - must be done manually
     * @param subCategoryId
    ...
    /**
     * Deactivate a sub category by its ID
     * CASCADE: Also deactivates all books in this sub category
     * @param subCategoryId
     * @return SubCategoryResponse
     */
    @Transactional
    public SubCategoryResponse deactivateSubCategory(Integer subCategoryId) {
        ...
        bookRepository.updateActiveBySubCategoryId(subCategory.getId(), false);
