...
//                        .requestMatchers(HttpMethod.GET, ADMIN_GET_ENDPOINTS).hasAnyAuthority("SCOPE_ADMIN")
     ...
     * Converts space-separated scope values (e.g., "SCOPE_ADMIN SCOPE_STAFF") into granted authorities.
     *
    ...
    JwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        grantedAuthoritiesConverter.setAuthorityPrefix(""); // No additional prefix needed, already in token
