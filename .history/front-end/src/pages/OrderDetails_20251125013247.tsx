          ...
          {statuses.map((status, index) => {
            ...
            return (
              <div key={status} className="flex flex-col items-center" style={{ flex: 1 }}>
                <div
                  className={`w-16 h-16 rounded-full flex items-center justify-center border-4 transition-all ${isCompleted
                ...
                <div className="mt-3 text-center">
                  <p
                    className={`text-sm font-semibold ${isCompleted ? "text-beige-900" : "text-gray-500"
                      }`}
                  >
                    {statusLabels[status]}
                  </p>
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          {isPaymentPending && (
            <button
              ...
              className="px-5 py-2.5 text-sm font-semibold text-white bg-green-600 rounded-md hover:bg-green-700 transition-colors"
            >
              Complete Payment
            </button>
          )}
          {canCancelOrder(order.status) && !isPaymentPending && (
            <button
              ...
              className="px-5 py-2.5 text-sm font-semibold border rounded-md text-red-600 bg-white border-red-300 hover:bg-red-50 transition-colors"
            >
              Cancel Order
            </button>
          )}
          {canChangeAddress(order.status) && !isPaymentPending && (
            <button
              ...
              className="px-5 py-2.5 text-sm font-semibold border rounded-md text-beige-700 bg-white border-beige-300 hover:bg-beige-50 transition-colors"
            >
              Change Address
            </button>
          )}
