              ...
              <div className="space-y-4 lg:col-span-2">
                ...
                {itemsWithDetails.map((item) => {
                  ...
                  return (
                    <div
                      key={key}
                      className={`grid grid-cols-[auto,1fr,200px] gap-4 p-4 transition-all duration-300 bg-white border shadow-sm rounded-xl hover:shadow-md ${
                        item.selected ? "border-beige-300" : "border-beige-100"
                      }`}
                    >
