              ...
              <div className="space-y-4 lg:col-span-2">
                ...
                {itemsWithDetails.map((item) => (
                  <div
                    ...
                    className={`grid grid-cols-[auto,1fr,auto] gap-6 p-6 transition-all duration-300 bg-white border shadow-sm rounded-xl hover:shadow-md ${
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between min-w-0">
                      <div>
                        <h2 className="mb-1 text-lg font-bold text-beige-900 line-clamp-2">
                          {item.title}
                        </h2>
                        {item.categoryName && (
                        ...
                        <p className="text-2xl font-semibold text-beige-700">
                      ...
                      <div className="flex items-center gap-3 mt-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="w-12 text-lg font-semibold text-center text-beige-900">
                            {item.quantity}
                          </span>
                          <button
                            onClick={() =>
