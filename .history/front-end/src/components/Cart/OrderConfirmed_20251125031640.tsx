        ...
        try {
          ...
          if (vnp_ResponseCode === "00") {
            ...
            try {
              ...
              // Backend returns success response but doesn't include payment record
              // We need to extract order ID from localStorage or orderInfo
              const storedOrderId = localStorage.getItem('vnpay_pending_order_id');
              ...
              if (storedPaymentId) {
                ...
                await paymentApi.markPaymentDone(parseInt(storedPaymentId));
              ...
              if (storedOrderId) {
                console.log("🔄 Redirecting to /order-confirmed/" + storedOrderId);
                navigate(`/order-confirmed/${storedOrderId}`, { replace: true });
              } else {
