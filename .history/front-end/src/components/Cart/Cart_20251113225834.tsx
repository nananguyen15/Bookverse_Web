                        ...
                        <div className="flex flex-row gap-2">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="flex items-center justify-center w-5 h-5 transition-all duration-200 border rounded-lg border-beige-300 text-beige-700 hover:bg-beige-50 hover:border-beige-400 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                              +
                            </button>
                          </div>
