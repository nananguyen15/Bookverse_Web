...
export function OrderConfirmation() {
  ...
  return (
    <>
      <Navbar />
      <div className="flex flex-col items-center justify-center min-h-screen px-4 py-12 pt-24 text-center bg-beige-50">
        <div className="max-w-md p-8 bg-white rounded-lg shadow-xl">
          ...
          <p className="mb-1 text-lg font-semibold text-gray-700">
            Order ID:{" "}
            <span className="font-mono text-indigo-600">{orderId}</span>
          </p>
