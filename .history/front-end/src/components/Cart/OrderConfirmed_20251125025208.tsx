  ...
  useEffect(() => {
    ...
    const processPayment = async () => {
      ...
      if (vnp_ResponseCode) {
        ...
        try {
          // Step 3: Get paymentId from localStorage (saved before redirect to VNPay)
          ...
          const paymentId = parseInt(storedPaymentId, 10);

          if (isNaN(paymentId)) {
            throw new Error("Invalid payment ID from localStorage");
          }
