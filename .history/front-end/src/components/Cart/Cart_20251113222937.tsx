              ...
              <div className="space-y-4 lg:col-span-2">
                ...
                {itemsWithDetails.map((item) => {
                  ...
                  return (
                    <div
                      key={key}
                      className={`grid grid-cols-3 gap-4 p-6 transition-all duration-300 bg-white border shadow-sm rounded-xl hover:shadow-md ${
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <div className="relative w-full group">
                          <img
                            src={item.image}
                            alt={item.title}
                            className="object-cover w-full transition-transform duration-300 rounded-lg aspect-[3/4] group-hover:scale-105"
                          />
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col justify-between">
                        <div>
                          <h2 className="mb-2 text-lg font-bold text-beige-900 line-clamp-2">
                            {item.title}
                          </h2>
                          {item.categoryName && (
                            <p className="mb-2 text-sm text-beige-500">
                              Category: {item.categoryName}
                            </p>
                          )}
                          <p className="mb-1 text-xl font-semibold text-beige-700">
                      ...
                      {/* Column 3: Quantity + Total + Remove */}
                        ...
                        <div className="flex flex-col items-end gap-2">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <input
                              ...
                              className="w-16 px-2 py-1 text-lg font-semibold text-center border rounded-lg border-beige-300 focus:ring-2 focus:ring-beige-500 focus:border-beige-500"
                            />
                            <button
                              onClick={() =>
                                updateQuantity(
