              ...
              <div className="p-6 bg-white rounded-lg shadow-sm lg:col-span-1 h-fit">
                ...
                <div className="space-y-3 mt-6">
                  ...
                  <button
                    ...
                    className="w-full py-3 font-semibold text-white transition-colors rounded-lg bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {paymentLoading ? (
                      <>
