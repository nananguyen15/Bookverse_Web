    ...
    <div className="p-6 bg-white border rounded-lg shadow-sm border-beige-100 hover:shadow-md transition-shadow">
      <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
              ...
              <>
                ...
                {isPaymentPending && (
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold text-white bg-green-600 rounded-full hover:bg-green-700 transition-colors"
        ...
        <div className="flex items-center gap-2">
          <Link
            to={`/order/${order.id}`}
            className="p-2 text-white rounded-lg bg-beige-700 hover:bg-beige-800 transition-colors"
            title="View Details"
          >
          ...
          {canCancelOrder(order.status) && !isPaymentPending && (
            <button
              ...
              className="p-2 border rounded-lg text-red-600 bg-white border-red-300 hover:bg-red-50 transition-colors"
              title="Cancel Order"
            >
          ...
          {canChangeAddress(order.status) && !isPaymentPending && (
            <button
              ...
              className="p-2 border rounded-lg text-beige-700 bg-white border-beige-300 hover:bg-beige-50 transition-colors"
          ...
          {order.status === "DELIVERED" && (
            <>
              <button
                ...
                className="p-2 text-white rounded-lg bg-beige-600 hover:bg-beige-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <button
                ...
                className="p-2 text-white bg-yellow-500 rounded-lg hover:bg-yellow-600 transition-colors"
                title="Write Review"
              >
