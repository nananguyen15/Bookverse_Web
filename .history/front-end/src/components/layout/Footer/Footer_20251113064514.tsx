...
export function Footer({ className }: FooterProps) {
  ...
  const handleCategoriesClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
    ...
    // If currently on home page, scroll to categories section
    if (location.pathname === "/") {
      ...
      // Navigate to home page, then scroll to categories
      navigate("/#browse-categories");
    }
  };

  const defaultClassName =
    "text-white bg-gradient-to-b from-beige-500 via-beige-700 to-beige-800";
  const footerClassName = className || defaultClassName;
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <p className="mb-4 text-sm leading-relaxed opacity-90">
              Your trusted partner for quality books collections.
            </p>
