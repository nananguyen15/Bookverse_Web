...
export function OrderManagement() {
  ...
  const handleEditStatus = async () => {
    ...
    try {
      await orderApi.updateOrder(parseInt(selectedOrder.orderId), {
        status: newStatus,
  ...
  const handleCancelOrder = async () => {
    ...
    try {
      ...
      // Create notification (keep localStorage until backend implements notification API)
      createNotification(
        `Order Cancelled`,
    ...
    <div className="p-6 bg-beige-50 min-h-screen">
      ...
      {loading ? (
        <div className="bg-white rounded-lg shadow-sm p-8 text-center">
          <p className="text-beige-600">Loading orders...</p>
        </div>
      ) : (
        <>
      {/* Search and Filters */}
                  ...
                  <div className="bg-beige-50 p-4 rounded-lg">
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span>Subtotal:</span>
                        <span>
                          ${selectedOrder.summary.subtotal.toFixed(2)}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span>Shipping:</span>
                        <span>
                          ${selectedOrder.summary.shipping.toFixed(2)}
                        </span>
                      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-md w-full">
            ...
            <div className="p-6">
              ...
              <div>
                <label htmlFor="newStatus" className="block text-sm font-medium text-beige-700 mb-2">
                  New Status
                </label>
                <select
                  id="newStatus"
