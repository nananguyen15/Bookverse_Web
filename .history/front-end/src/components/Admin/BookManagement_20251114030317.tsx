...
export function BookManagement() {
    ...
    .sort((a, b) => {
      ...
      switch (sortField) {
        ...
        case "author":
          ...
          break;
        case "publisher":
          aVal = a.publisherName || "";
          bVal = b.publisherName || "";
          break;
        case "price":
          aVal = a.price;
          bVal = b.price;
  ...
  const handleCreate = async () => {
    try {
      ...
      if (formData.publishedDate) {
        ...
        console.log("Validating date:", formData.publishedDate);
        ...
        console.log("Input components:", { year, month, day });
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      const updateData: Record<string, string | number | File | boolean> = {
        ...formData,
  ...
  const openEditModal = (book: Book) => {
    ...
    // Convert publishedDate to YYYY-MM-DD format for the date input
    let formattedDate = "";
