        ...
        <CartProvider>
          <Routes>
            ...
            <Route path="/staff" element={<StaffOnlyRoute><StaffLayout /></StaffOnlyRoute>}>
              ...
              <Route path="books" element={<BookManagementNew noLayout={true} />} />
              ...
              <Route path="sup-categories" element={<SupCategoryManagementNew noLayout={true} />} />
              <Route path="sub-categories" element={<SubCategoryManagementNew noLayout={true} />} />
              <Route path="orders" element={<OrderManagementNew noLayout={true} />} />
              <Route path="reviews" element={<ManageReviewNew noLayout={true} />} />
